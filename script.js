...
const data = {
    ...
    movie: [
        { title: "Inception 🌀", desc: "فيلم خيال علمي عن سرقة الأحلام. هل أنت في حلم أم واقع؟", rating: "⭐⭐⭐⭐⭐" },
        { title: "The Dark Knight 🦇", desc: "أفضل فيلم سوبر هيرو في التاريخ. أداء الجوكر لا ينسى.", rating: "⭐⭐⭐⭐⭐" },
        { title: "Interstellar 🚀", desc: "رحلة عبر الثقوب الدودية لإنقاذ البشرية. موسيقى هانز زيمر ساحرة.", rating: "⭐⭐⭐⭐⭐" },
        { title: "Parasite 🏠", desc: "فيلم كوري عبقري عن الطبقية الاجتماعية. نهاية صادمة!", rating: "⭐⭐⭐⭐⭐" },
        { title: "The Godfather 🌹", desc: "ملحمة العصابات الكلاسيكية. عرض لا يمكنك رفضه.", rating: "⭐⭐⭐⭐⭐" },
        { title: "Spirited Away 🐉", desc: "أنمي ساحر من استوديو جيبلي. رحلة شيهيرو في عالم الأرواح.", rating: "⭐⭐⭐⭐⭐" },
        { title: "Coco 🎸", desc: "فيلم عائلي مؤثر عن الموسيقى والذاكرة. جهز المناديل!", rating: "⭐⭐⭐⭐⭐" }
    ],
    song: [
        { title: "أنت عمري - أم كلثوم 🎤", desc: "لقاء السحاب. أغنية طربية تأخذك لعالم آخر.", rating: "⭐⭐⭐⭐⭐" },
        { title: "Bohemian Rhapsody 👑", desc: "تحفة فرقة Queen. مزيج غريب وعبقري من الروك والأوبرا.", rating: "⭐⭐⭐⭐⭐" },
        { title: "Shape of You ➗", desc: "أغنية بوب إيقاعية لإد شيران. مستحيل ما ترقص عليها!", rating: "⭐⭐⭐⭐" },
        { title: "ثلاث دقات 🏖️", desc: "أغنية الصيف الرسمية. جو بحر ورومانسية.", rating: "⭐⭐⭐⭐" },
        { title: "Imagine ☮️", desc: "نشيد السلام العالمي لجون لينون. كلمات تلمس القلب.", rating: "⭐⭐⭐⭐⭐" },
